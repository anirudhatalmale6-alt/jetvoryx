...
const baseTemplate = (content: string) => `
  <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #06172b; color: #ffffff; border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; overflow: hidden;">
    <div style="padding: 24px 32px; background: linear-gradient(135deg, #0a1e38, #06172b); border-bottom: 1px solid rgba(201,168,76,0.3);">
    ...
    <div style="padding: 16px 32px; background: #0a1e38; border-top: 1px solid rgba(255,255,255,0.05); text-align: center;">
...
export function emailRequestReceived(data: {
  ...
  return {
    ...
    html: baseTemplate(`
      ...
      <div style="background: #0a1e38; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: 20px; margin: 24px 0;">
...
export function emailStatusUpdate(data: {
  ...
  return {
    ...
    html: baseTemplate(`
      ...
      <div style="background: #0a1e38; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: 20px; margin: 24px 0; text-align: center;">
  ...
  return {
    ...
    html: baseTemplate(`
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${data.paymentUrl}" style="display: inline-block; background: linear-gradient(135deg, #c9a84c, #d4af37); color: #06172b; padding: 14px 40px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 14px;">Complete Payment</a>
      </div>
